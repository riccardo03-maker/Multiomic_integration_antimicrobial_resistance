...
ggsave("plots/figure_7/cef_scores.png", plot = cef_plot, width = 6.67, height = 6.67)
...
cip_plot <- ggplot(data = cip_scores, aes(x = algorithm, y = accuracy, fill = features)) +
    ...
    geom_text(aes(label = round(accuracy, digits = 2), vjust = 2)) +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave("plots/figure_7/cip_scores.png", plot = cip_plot, width = 6.67, height = 6.67)
...
mer_plot <- ggplot(data = mer_scores, aes(x = algorithm, y = accuracy, fill = features)) +
    ...
    geom_text(aes(label = round(accuracy, digits = 2), vjust = 2)) +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave("plots/figure_7/mer_scores.png", plot = mer_plot, width = 6.67, height = 6.67)
...
tob_plot <- ggplot(data = tob_scores, aes(x = algorithm, y = accuracy, fill = features)) +
    ...
    geom_text(aes(label = round(accuracy, digits = 2), vjust = 2)) +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave("plots/figure_7/tob_scores.png", plot = tob_plot, width = 6.67, height = 6.67)